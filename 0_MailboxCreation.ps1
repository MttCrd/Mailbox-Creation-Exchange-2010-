param (
	...
	[string]$Atypical = $(throw "-Atypical is required.")
...
# ======================================================
    ...
    if ($Domain -eq 2){ #
        ...
        # ======================================================
            ...
            Set-Mailbox –identity "$Alias" -ManagedFolderMailboxPolicy 'ENI Managed Folder Policy' -ManagedFolderMailboxPolicyAllowed -Confirm:$false
